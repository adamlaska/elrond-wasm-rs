...
const THE_DIGITAL_CASH_CONTRACT_ADDRESS: TestSCAddress =
    TestSCAddress::new("the_digital_cash_contract");
const ACC1_ADDRESS: TestAddress = TestAddress::new("acc1");
const ACC2_ADDRESS: TestAddress = TestAddress::new("acc2");
const DIGITAL_CASH_OWNER_ADDRESS_ADDRESS: TestAddress =
    TestAddress::new("digital_cash_owner_address");
...
pub fn set_accounts_scen_steps(world: &mut ScenarioWorld) {
    ...
    world.account(ACC2_ADDRESS).nonce(0u64).balance(1000000u64);
    world.account(ACC3_ADDRESS).nonce(0u64).balance(1000000u64);
    world
        .account(DIGITAL_CASH_OWNER_ADDRESS_ADDRESS)
        .nonce(0u64)
        .balance(0u64);
    ...
    world
        ...
        .init(
            ...
            ScenarioValueRaw::str("str:EGLD-000000"),
            ScenarioValueRaw::str("10"),
        )
    ...
    world
        .check_account(THE_DIGITAL_CASH_CONTRACT_ADDRESS)
        .check_storage("str:baseFee|nested:str:EGLD-000000", "10")
        .check_storage("str:feesDisabled", "false");
}
